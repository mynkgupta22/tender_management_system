...
public class TenderDto {
	...
	public TenderDto(int tender_id, String tender_name, String start_date, String last_date,
			String vendor_email, boolean isAssigned) {
		super();
		this.tender_id = tender_id;
		this.tender_name = tender_name;
		this.start_date = start_date;
	...
	public String toString() {
		return "TenderDto [tender_id=" + tender_id + ", tender_name=" + tender_name + ", start_date=" + start_date
				+ ", last_date=" + last_date + ",   vendor_email=" + vendor_email
